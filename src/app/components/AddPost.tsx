    ...
    return (
        <>
            <div className="bg-white border-2 border-gray-300 rounded-md m-4 text-black flex flex-col p-4 pb-8 gap-2 relative">
                ...
                <input placeholder="Título da postagem" className="bg-gray-100 p-2 rounded-md outline-gray-400" type="text" value={inputTitle} onChange={e => setInputTitle(e.target.value)} />
